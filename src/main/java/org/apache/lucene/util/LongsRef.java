...
/**
 * Represents long[], as a slice (offset + length) into an existing long[]. The
 * {@link #longs} member should never be null; use {@link #EMPTY_LONGS} if
 * necessary.
 * 
 * @lucene.internal
 */
public final class LongsRef implements Comparable<LongsRef>, Cloneable {
  ...
  /**
   * This instance will directly reference longs w/o making a copy. longs should
   * not be null
   */
