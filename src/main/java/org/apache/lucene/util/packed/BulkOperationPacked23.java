...
final class BulkOperationPacked23 extends BulkOperationPacked {
  ...
  public void decode(byte[] blocks, int blocksOffset, int[] values,
    ...
    for (int i = 0; i < 8 * iterations; ++i) {
      ...
      values[valuesOffset++] = ((byte2 & 1) << 22) | (byte3 << 14)
          | (byte4 << 6) | (byte5 >>> 2);
      final int byte6 = blocks[blocksOffset++] & 0xFF;
      final int byte7 = blocks[blocksOffset++] & 0xFF;
      final int byte8 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte5 & 3) << 21) | (byte6 << 13)
          | (byte7 << 5) | (byte8 >>> 3);
      final int byte9 = blocks[blocksOffset++] & 0xFF;
      final int byte10 = blocks[blocksOffset++] & 0xFF;
      final int byte11 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte8 & 7) << 20) | (byte9 << 12)
          | (byte10 << 4) | (byte11 >>> 4);
      final int byte12 = blocks[blocksOffset++] & 0xFF;
      final int byte13 = blocks[blocksOffset++] & 0xFF;
      final int byte14 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte11 & 15) << 19) | (byte12 << 11)
          | (byte13 << 3) | (byte14 >>> 5);
      ...
      values[valuesOffset++] = ((byte14 & 31) << 18) | (byte15 << 10)
          | (byte16 << 2) | (byte17 >>> 6);
      ...
      values[valuesOffset++] = ((byte17 & 63) << 17) | (byte18 << 9)
          | (byte19 << 1) | (byte20 >>> 7);
