...
abstract class Packed64SingleBlock extends PackedInts.MutableImpl {
  ...
  public int get(int index, long[] arr, int off, int len) {
    ...
    final PackedInts.Decoder decoder = BulkOperation.of(
        PackedInts.Format.PACKED_SINGLE_BLOCK, bitsPerValue);
  ...
  public int set(int index, long[] arr, int off, int len) {
    ...
    // bulk set
    assert index % valuesPerBlock == 0;
    final BulkOperation op = BulkOperation.of(
        PackedInts.Format.PACKED_SINGLE_BLOCK, bitsPerValue);
  ...
  public static Packed64SingleBlock create(DataInput in, int valueCount,
  ...
  public static Packed64SingleBlock create(int valueCount, int bitsPerValue) {
    ...
    default:
      throw new IllegalArgumentException(
          "Unsupported number of bits per value: " + 32);
    }
  }
